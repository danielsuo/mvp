...
(function() {
    ...
    SVG.extend(SVG.Element, {
        ...
        resize: function(options) {
            ...
            var resize, update, done, calc, defaults, snapToGrid, element = this;
            SVG.registerEvent('resized');
                ...
                switch (event.type) {
                    ...
                    case 'rot':
                        ...
                        calc = function(diffX, diffY) {
                            ...
                            element.center(element.startParams.rbox.cx - 2, element.startParams.rbox.cy - 1.5).transform({
                                rotation: element.startParams.rotation + diffX / defaults.rotPrecision,
                                cx: element.startParams.rbox.cx,
                                cy: element.startParams.rbox.cy
                            });
                        };
                        break;
            ...
            update = function(event) {
                ...
                event = event || window.event;
                element.fire('resized', {element: element, event: event});
